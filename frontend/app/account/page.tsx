            ...
            <div className="p-8">
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start md:items-center">
                <div className="relative">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center text-2xl font-bold text-white shadow-2xl shadow-blue-500/20">
                    JD
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 flex-1">
                  <div>
                    ...
                    <p className="text-slate-200 font-medium">John Doe</p>
                  </div>
                  <div>
                    <label className="flex items-center text-xs font-semibold text-slate-500 uppercase tracking-widest mb-2">
                      <Mail size={12} className="mr-1.5" /> Email Address
                    </label>
                    <p className="text-slate-200 font-medium">john.doe@assethub.com</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="bg-slate-900/40 border border-slate-800 rounded-2xl backdrop-blur-sm overflow-hidden">
            <div className="p-8">
              ...
              <div className="space-y-4 max-w-md">
                ...
                <button className="mt-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-blue-500/20">
                  Update Password
                </button>
              </div>
            </div>
